...
class avaliacaoDAO
{
    ...
    public function tabelapaginada() {
        ...
        $sql = "SELECT idAvaliacao, c.Nome as Curso, t.Nome as Turma, a.Nome as Aluno, Nota1, Nota2, NotaFinal 
                  FROM avaliacao av INNER JOIN
                       curso c on av.Curso_idCurso = c.idCurso INNER JOIN
                       turma t on av.Turma_idTurma = t.idTurma INNER JOIN
                       aluno a on av.Aluno_idAluno = a.idAluno LIMIT {$linha_inicial}, " . QTDE_REGISTROS;
